                    ...
                    <li class="-mx-6 mt-auto">
                      ...
                      >
                        <img
                          ...
                          :alt="user.name"
                        />
                        <span class="sr-only">{{ trans.view_profile }}</span>
        ...
        <nav class="flex flex-1 flex-col">
          <ul role="list" class="flex flex-1 flex-col gap-y-7">
            ...
            <li class="-mx-6 mt-auto">
              <a
                href="#"
                class="flex items-center gap-x-4 px-6 py-3 text-sm font-semibold leading-6 text-white hover:bg-gray-800 cursor-pointer"
              >
                <img
                  class="h-8 w-8 rounded-full bg-gray-800"
                  :src="user.avatar || user.default_avatar"
        ...
        <ul role="list" class="divide-y divide-white/5">
          ...
          >
            ...
            <p class="mt-3 truncate text-sm text-gray-500">
              Pushed to
              <span class="text-gray-400">{{ item.projectName }}</span>
              (<span class="font-mono text-gray-400">{{ item.commit }}</span>
              on
