<template>
  <div v-cloak class="position-relative">
    <div
      v-closable="handleClicksOutsideEditor"
      ref="sidebarControls"
      class="sidebar-controls"
    >
      <button
        ref="toggle"
        class="btn btn-circle border"
        type="button"
      ...
      <div class="controls pl-3 d-none">
        <button
          class="btn btn-circle border mr-1"
          type="button"
        ...
        <button
          class="btn btn-circle border mr-2"
          type="button"
          @click="insertDivider"
        >
          <svg
    ...
    >
      <div class="btn-group d-flex justify-content-center">
        ...
        <button
          class="btn border border-bottom-0 border-right-0 py-2"
          type="button"
          @click="insertDivider"
        >
          <svg
    ...
    <embed-content-modal
      ...
      @adding-embed-content="insertEmbedContent"
    />
    <embed-image-modal
      ref="embedImageModal"
