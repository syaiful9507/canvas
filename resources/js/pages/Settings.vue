    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
        ...
        <div class="py-4">
            <div class="mt-10 divide-y divide-gray-200 dark:divide-gray-700">
                <div class="space-y-1">
                    ...
                    <p
                        class="max-w-2xl text-sm text-gray-500 dark:text-gray-300"
                    >
                    ...
                    <dl class="divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <div class="flex items-center justify-between py-4">
                            ...
                            <div class="relative inline-block text-left">
                                <p
                                    class="text-sm text-gray-600 dark:text-gray-300 py-2"
                                >
                                    {{ config.version }}
                                </p>
                            </div>
        ...
        >
            <div class="py-10">
                ...
                >
                    <AppLink
                        to="https://github.com/austintoddj/canvas#introduction"
                    >
                        {{ trans.documentation }}
                    </AppLink>
                    <div
                        class="h-4 w-px bg-gray-500/20 dark:bg-gray-300/20"
                    ></div>
                    <AppLink
                        to="https://github.com/austintoddj/canvas/releases"
                    >
                        {{ trans.changelog }}
                    </AppLink>
                </div>
