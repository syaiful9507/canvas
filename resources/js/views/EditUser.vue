        ...
        <div v-if="!creatingUser" class="mt-4 card shadow-lg">
          <div class="card-body py-4">
            <div class="row">
              ...
              <div
                class="col-12 col-md-9 align-self-center px-0 text-center text-md-left"
              >
                <h5 class="mt-0 mb-1 font-weight-bold">{{ user.name }}</h5>
                <a
                  class="mb-1 text-primary text-decoration-none"
                  :href="`mailto:${user.email}`"
                  >{{ user.email }}</a
                >
                <p class="text-secondary mb-0">
                  {{ numberOfPosts }} ― Created
          ...
          <div class="card-body">
            <div class="col-12">
              ...
              <div v-if="!creatingUser" class="form-group row">
                ...
                />
                <span
                  v-if="invalidUsername.shouldShow"
                  class="invalid-feedback"
                  role="alert"
                >
              ...
              <div class="form-group row">
                ...
                />
                <span
                  v-if="invalidPassword.shouldShow"
                  class="invalid-feedback"
                  role="alert"
                >
                  ...
                  <div class="ml-auto">
                    <div class="d-none d-md-inline">
                      <span class="text-secondary mr-3"
                        ...
                        {{
                          post.views_count == 1 ? trans.view : trans.views
                        }}</span
                      >
                      <span class="mr-3"
                        >{{ trans.created }}
  ...
  computed: {
    ...
    shouldDisableSaveButton() {
      if (this.creatingUser) {
        return (
          isEmpty(this.user.name) ||
          isEmpty(this.user.email) ||
          isEmpty(this.user.password)
        )
      } else {
    ...
    numberOfPosts() {
      let noun =
        this.user.posts_count === 1 ? this.trans.post : this.trans.posts
